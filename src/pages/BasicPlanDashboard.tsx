    ...
    <div style={{ minHeight: '100vh', background: '#f5f9fa' }}>
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '16px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            <div style={{
              ...
              <MessageCircle style={{ width: '28px', height: '28px', color: '#83b3d8' }} />
            </div>
            <div>
              <h1 style={{ fontSize: '28px', fontWeight: 'bold', color: 'white', margin: 0 }}>TalkKin</h1>
              <p style={{ fontSize: '14px', color: 'rgba(255,255,255,0.9)', margin: 0 }}>Your Memory Avatar</p>
            </div>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            <div style={{ textAlign: 'right' }}>
              <p style={{ fontSize: '14px', fontWeight: '600', color: 'white', margin: 0 }}>Basic Plan</p>
              <p style={{ fontSize: '12px', color: 'rgba(255,255,255,0.85)', margin: 0 }}>2 family seats</p>
            </div>
            <div style={{
              width: '48px',
              height: '48px',
      ...
      <div style={{ background: 'white', borderBottom: '2px solid #b3e1f4', position: 'sticky', top: 0, zIndex: 40 }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 24px', display: 'flex', gap: '8px', overflowX: 'auto' }}>
          {[
            { id: 'interact', icon: MessageCircle, label: 'Chat with Avatar' },
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '24px' }}>
                  <div style={{
                    ...
                    <div style={{
                      ...
                      justifyContent: 'center',
                      marginBottom: '24px',
                      animation: isAvatarThinking ? 'pulse 1.5s infinite' : 'none',
                      boxShadow: '0 8px 32px rgba(0,0,0,0.1)'
                    }}>
                      <User style={{ width: '64px', height: '64px', color: 'white' }} />
                    </div>
                    <p style={{
                      fontSize: '18px',
                      fontWeight: '600',
                      ...
                      {isAvatarThinking ? 'Thinking...' : 'Ready to chat'}
                    </p>
                    {isAvatarThinking && (
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '16px' }}>
                    {[
                      { icon: MessageCircle, value: '127', label: 'Conversations', color: 'rgba(255,255,255,0.9)' },
                      { icon: Upload, value: '89', label: 'Memories', color: 'rgba(255,255,255,0.9)' },
                      { icon: Users, value: '0/2', label: 'Family Access', color: 'rgba(255,255,255,0.9)' },
                      { icon: TrendingUp, value: '+18%', label: 'This Month', color: 'rgba(255,255,255,0.9)' }
            ...
            <div style={{
              ...
              <div style={{
                ...
                <p style={{ fontSize: '14px', color: '#6b7280', margin: 0 }}>
                  Ask about memories, stories, and shared experiences
                </p>
              </div>
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
                  <input
                    ...
                    placeholder="Ask about your stories, recipes, memories..."
                    style={{
                      flex: 1,
                      padding: '18px 28px',
          ...
          <div style={{
            ...
            <div style={{
              ...
              <h2 style={{
                ...
                <User style={{ width: '28px', height: '28px', color: '#83b3d8' }} />
                Avatar Settings
              </h2>
        ...
        {activeTab === 'billing' && (
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ position: 'relative', zIndex: 1 }}>
                <h3 style={{ fontSize: '28px', fontWeight: 'bold', marginBottom: '12px' }}>Basic Plan</h3>
                <div style={{ display: 'flex', alignItems: 'baseline', gap: '8px', marginBottom: '20px' }}>
                  <p style={{ fontSize: '56px', fontWeight: 'bold', margin: 0 }}>$19</p>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <span style={{
                  ...
                  fontSize: '14px',
                  fontWeight: '600',
                  boxShadow: '0 2px 8px rgba(242, 145, 27, 0.3)'
                }}>Popular</span>
              </div>
              <p style={{
                color: '#6b7280',
                ...
                Get your actual voice, appearance, and video avatar with AI-powered features
              </p>
              <div style={{ marginBottom: '24px' }}>
                <div style={{ display: 'flex', alignItems: 'baseline', gap: '8px', marginBottom: '16px' }}>
                  <p style={{ fontSize: '40px', fontWeight: 'bold', color: '#1f2937', margin: 0 }}>$59</p>
                  <span style={{ fontSize: '18px', color: '#6b7280' }}>/month</span>
                </div>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                  {['Video avatar with your voice', '5 family access seats', 'Custom appearance & voice'].map((feature, idx) => (
                    <div key={idx} style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                      <Sparkles style={{ width: '18px', height: '18px', color: '#f2911b' }} />
                      <span style={{ fontSize: '14px', color: '#1f2937' }}>{feature}</span>
                    </div>
                  ))}
                </div>
              </div>
              <button style={{
                ...
                border: 'none',
                cursor: 'pointer',
                boxShadow: '0 4px 16px rgba(242, 145, 27, 0.4)',
                fontSize: '17px',
                transition: 'transform 0.2s, box-shadow 0.2s'
              }}>
                Upgrade Now
